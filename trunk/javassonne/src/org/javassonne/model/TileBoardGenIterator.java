...
public class TileBoardGenIterator implements TileBoardIterator {
	...
	public TileBoardIterator downCopy() {
		return new TileBoardGenIterator(data_, new IntPair(location_.car() + 1, location_.cdr()));
	}
	...
	public TileBoardIterator leftCopy() {
		return new TileBoardGenIterator(data_, new IntPair(location_.car(), location_.cdr() - 1));
	}
