...
public class ClientImpl implements Client {
	...
	/**
	 * Do not allow the client to be constructed without a localHost URI
	 */
	private ClientImpl() {
	}
	...
	public ClientImpl(String name) {
		...
		try {
			...
			service_ = RemotingUtils.exportRMIService(this, Client.class,
					SERVICENAME + "_" + name);
	...
	/**
	 * List all hosts that this client could potentially connect to. Filter out
	 * the local host
	 * 
