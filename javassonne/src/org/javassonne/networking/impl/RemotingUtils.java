...
public class RemotingUtils {
	...
	/**
	 * This method takes an object and exposes it as a remove RMI service.
	 * The class that is passed should be the interface that you want the
	 * service exposed as. The name will be used to create the url for the
	 * service. e.g. if you provide the name "foo", and your ip address
	 * is 123.45.67.89, the following url will access the service:
	 * rmi://123.45.67.89:1099/foo
	 * 
	 * @param svc - the object that is to be exposed as a remote RMI service
	 * @param svcinterface - the interface on the object to expose
	 * @param name - the name of the service for the url
	 ...
	 * This method takes an object and exposes it as a remove RMI service.
	 * The class that is passed should be the interface that you want the
	 * service exposed as. The name and port will be used to create the url for the
	 * service. e.g. if you provide the name "foo", port 5555, and your ip address
	 * is 123.45.67.89, the following url will access the service:
	...
	/**
	 * This method connects to a remote object exposed through RMI
	 * and returns a handle to it. The object can be used just like
	 * any ordinary Java object. The uri should be the uri that the
	 * remote service is exposed under. The svcinterface should be the
	 * interface that you expect the object to have. 
	 * 
	 * 
	 * @param uri
	 * @param svcinterface
	 ...
	 * @return
	 */
	public static Object lookupRMIService(String host, int port, String svcname, Class svcinterface){
	 ...
	 * @return
	 */
	public static Object lookupRMIService(String host, String svcname, Class svcinterface){
	 ...
	 * @return
	 */
	public static Object lookupLocalRMIService(String svcname, Class svcinterface){
